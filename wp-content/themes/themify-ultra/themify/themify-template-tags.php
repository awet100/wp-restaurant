...
if (!function_exists('themify_comments')) {
    ...
    function themify_comments() {
		...
		<div id="comments" class="commentwrap tf_clearfix">
            ...
            elseif(true===$hasComment && themify_is_themify_theme() && Themify_Filesystem::exists(Themify_Enqueue_Assets::$THEME_CSS_MODULES_URI.'comments.css')){
...
function themify_menu_nav( $args = array(),$reinit=false ) {
    ...
    $cacheDisable=$reinit===true  || themify_isDevMode() || TFCache::get_cache_plugins('any') || themify_check('setting-cache-menu',true) || themify_check('setting-cache-html',true);    
