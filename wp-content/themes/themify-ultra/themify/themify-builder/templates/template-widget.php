...
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
	...
	if(!empty($tmp) || $tmp===''){
	    ...
	    if ( $widget_name ) {
			...
			the_widget( $widget_name, $fields_args['instance_widget'],array('widget_id'=>isset($fields_args['instance_widget']['widget-id'])?$fields_args['instance_widget']['widget-id']: $args['module_ID']) );
