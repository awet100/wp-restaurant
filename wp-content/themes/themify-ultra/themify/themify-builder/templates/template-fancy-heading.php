...
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
    ...
    <span class="sub-head <?php echo $is_inline===true?'tf_inline_b':'tf_block'; ?> tf_rel"<?php if(Themify_Builder::$frontedit_active===true):?> contenteditable="false" data-name="sub_heading"<?php endif; ?>>
