		...
		foreach ($posts as $post): setup_postdata($post);
			...
			<div class="post-content">
				...
				<?php if ($fields_args['unlink_post_title_' . $mod_name] === 'yes'): ?>
				    <<?php echo $fields_args['title_tag_' . $mod_name];?> class="post-title"><?php the_title(); ?></<?php echo $fields_args['title_tag_' . $mod_name];?>>
				<?php else: ?>
				    <<?php echo $fields_args['title_tag_' . $mod_name];?> class="post-title"><a <?php themify_permalink_attr(); ?>><?php the_title(); ?></a></<?php echo $fields_args['title_tag_' . $mod_name];?>>
