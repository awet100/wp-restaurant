...
function themify_theme_enqueue_header() {
	...
	if ( themify_theme_is_fullpage_scroll() ){
		...
		if ( themify_check( 'fullpage_footer_section', false ) ) {
			themify_enque_style( 'themify-fullpage-footer', THEME_URI . '/styles/fullpage/fullpage-footer.css', null, $theme_version, $media, true );
		}
	    if ( $is_builder_off===true) {
...
if ( ! function_exists( 'themify_theme_body_class' ) ) {
	...
	function themify_theme_body_class( $classes ) {
		...
		if ( $is_fullpage_scroll && themify_check( 'fullpage_footer_section', false ) ) {
...
function themify_post_category_class( $classes ) {
    global $post,$themify;
	$categories = wp_get_object_terms($post->ID, empty($themify->query_taxonomy)?'category':$themify->query_taxonomy );
